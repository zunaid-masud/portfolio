...
# [Md Zunaid Masud Portfolio ](https://github.com/zunaid-masud)
...
## View live preview [here](https://asifuzzaman.com/).
...
```bash
git clone https://github.com/TonmoyAsif/asifuzzaman-portfolio
...
### Then, Customize data in the `utils/data` [folder](https://github.com/TonmoyAsif/asifuzzaman-portfolio/tree/main/utils/data).

Eg:

```javascript
export const personalData = {
  name: "F. M. ASIF-UZ-ZAMAN",
  profile: "/profile.png",
  designation: "Project Manager & Sr. Digital Marketer",
  description: "My name is TONMOY ASIF....",
  email: "tonmoy.asif@gmail.com",
  phone: "+8801763242444",
  address: "Rangpur, Bangladesh",
  github: "https://github.com/TonmoyAsif",
  facebook: "https://www.facebook.com/tonmoy.asif/",
  linkedIn: "https://www.linkedin.com/in/tonmoyasif/",
  devUsername: "tonmoy_asif",
  resume: "...",
};
```
