...
function ContactForm() {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      ...
      toast.success("Your email has been sent successfully! I'll get back to you soon.");
      setUserInput({
        name: "",
        email: "",
        message: "",
    ...
    <div>
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="userEmail" className="text-base">Your Email: </label>
            <input
              id="userEmail"
              className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-2"
              type="email"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="userMessage" className="text-base">Your Message: </label>
            <textarea
              id="userMessage"
              className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-2"
              maxLength="500"
